...
class Router
{
    ...
    public function parse($url)
    {
        ...
        exit('<div style="padding:15px;font-size:20px;background: #B0413E;color: #fff;">Sorry, the page you are looking for could not be found.<br>This URL could not be found in the route.<br>Please check your request address or your defined route param.</div>');
    }
}
$r = new Router($route);
